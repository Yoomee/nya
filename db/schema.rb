...
ActiveRecord::Schema.define(version: 20140922081102) do
  ...
  add_index "project_owners", ["owner_id"], name: "index_project_owners_on_owner_id", using: :btree
  add_index "project_owners", ["project_id"], name: "index_project_owners_on_project_id", using: :btree
